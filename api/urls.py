...
path(
    ...
    path("investor-accounts/farm/<int:batch_id>/", investor_accounts.farm_account_detail, name="farm_account_detail"),
    path("investor-accounts/farm/<int:batch_id>/contribution/", investor_accounts.record_farm_account_payment, name="record_farm_account_payment"),
    path("investor-accounts/farm/<int:batch_id>/sale-withdrawal/", investor_accounts.record_farm_sale_withdrawal, name="record_farm_sale_withdrawal"),
